...
let questions = [
    ...
    new Question(
        ...
        ["js", "script", "javascript", "scrpting"], "<script>"
    ),
    new Question(
        "The .container class provides a full widt container, spanning the entire width of the screen",
        ["False", "True","None of the above","NA"], "True"
    ),
